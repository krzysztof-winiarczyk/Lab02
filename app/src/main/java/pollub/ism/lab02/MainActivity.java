...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //podlaczenie uchwytow do widokow
    ...
    protected void onRestart() {
        super.onRestart();
        licznikRestart++;
        powiedzCoWykoonujesz("onRestart");
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        licznikDestroy++;
        powiedzCoWykoonujesz("onDestroy");
    }
